    ...
    <div class="col-md-10 p-4 pt-4">
      ...
      <form method="POST" action="">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="asal_sekolah" value="<?= $camaba ['asal_sekolah'] ?>" placeholder="Sekolah Asalmu" name="asal_sekolah" required autocomplete="off">
        </div>
        <div class="form-group">
          <label for="foto_camaba">Foto</label>
          <input type="text" class="form-control" id="foto_camaba" value="<?= $camaba ['foto_camaba'] ?>" placeholder="Foto" name="foto_camaba" required autocomplete="off">
        </div>
